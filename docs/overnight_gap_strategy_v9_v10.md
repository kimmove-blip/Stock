...
| 확률 임계값 | 거래수 | 승률 | 평균수익률 | 연간 총수익 |
|-------------|--------|------|------------|-------------|
| ≥50% | 18,245 | 55.9% | 0.128% | +2,335% |
| ≥60% | 5,927 | 59.2% | 0.269% | +1,594% |
| **≥70%** | **909** | **61.2%** | **0.388%** | **+353%** |
| ≥75% | 312 | 63.8% | 0.631% | +197% |
| ≥80% | 98 | 61.2% | 0.649% | +64% |
| ≥85% | 30 | 50.0% | 0.202% | +6% |

### 결론
- **확률 70% 이상 조건이 최적** (승률 61.2%, 연간 +353%)
- 하루 평균 3~4건 거래로 실용적
...
| 전략 | 거래수 | 승률 | 평균수익 | 연간 총수익 | 실용성 |
|------|--------|------|----------|-------------|--------|
| **V9 확률 ≥70%** | **909** | **61.2%** | **0.388%** | **+353%** | **최고** |
| V9 확률 ≥75% | 312 | 63.8% | 0.631% | +197% | 좋음 |
| V10 (2%+갭+B) | 76 | 68.4% | 1.41% | +107% | 낮음 |
| V10 확률80%+B | 54 | 66.7% | 0.88% | +48% | 낮음 |
| 시장 필터 | - | - | - | - | 효과없음 |
| 다일 보유 | - | ~43% | - | - | 효과없음 |
